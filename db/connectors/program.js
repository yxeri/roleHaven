...
function updateProgram({
  ...
  if (cost) { set.deviceType = cost; }
  if (programName) { set.deviceName = programName; }
...
exports.createDevice = createProgram;
exports.getDevicesByUser = getProgramsByUser;
exports.getDeviceById = getProgramById;
exports.removeDevice = removeProgram;
